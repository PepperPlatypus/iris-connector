import fs from 'fs';
import type { ResponseLike } from 'iris-connector/internal/to-file';
import { toFile } from 'iris-connector/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('iris-connector/core/uploads');
    await expect(
